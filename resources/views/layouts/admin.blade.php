...
<body data-ng-app>
                	...
                	<div class="dropdown-menu md arrow pull-right panel panel-default arrow-top-right messages-dropdown">
                        ...
                        <div class="list-group">
                            ...
                            <div class="media">
                              ...
                              <img class="media-object img-circle pull-left" src="{{asset('imgs/avtar/user2.png')}}" alt="user#1" width="40">
                              </div>
                            ...
                            <div class="media">
                              ...
                              <img class="media-object img-circle pull-left" src="{{asset('imgs/avtar/user3.png')}}" alt="user#1" width="40">
                              </div>
                              <div class="media-body">
                            ...
                            <div class="media">
                              ...
                              <img class="media-object img-circle pull-left" src="{{asset('imgs/avtar/user4.png')}}" alt="user#1" width="40">
                              </div>
                              <div class="media-body">
                            ...
                            <div class="media">
                              ...
                              <img class="media-object img-circle pull-left" src="{{asset('imgs/avtar/user5.png')}}" alt="user#1" width="40">
                              </div>
                              <div class="media-body">
                                ...
                                <ul class="media-list messages nicescroll">
                                    <li class="media">
                                      <a href="#" class="pull-left user-status online">
                                        <img alt="user" class="media-object" src="{{asset('imgs/avtar/user2.png')}}">
                                      </a>
                                      <div class="media-body">
                                    ...
                                    <li class="media">
                                      <a href="#" class="pull-right user-status offline">
                                        <img alt="user" class="media-object" src="{{asset('imgs/avtar/user3.png')}}">
                                      </a>
                                      <div class="media-body">
                                    ...
                                    <li class="media">
                                      <a href="#" class="pull-left user-status invisibled">
                                        <img alt="user" class="media-object" src="{{asset('imgs/avtar/user4.png')}}">
                                      </a>
                                      <div class="media-body">
                                        ...
                                        <div class="media">
                                          <a href="#" class="pull-left user-status online">
                                            <img alt="user" class="media-object" src="{{asset('imgs/avtar/user5.png')}}">
                                          </a>
                                          <div class="media-body">
                                        ...
                                        <div class="media">
                                          <a href="#" class="pull-left user-status online">
                                            <img alt="user" class="media-object" src="{{asset('imgs/avtar/user6.png')}}">
                                          </a>
                                          <div class="media-body">
                                    ...
                                    <li class="media">
                                      <a href="#" class="pull-left online">
                                        <img alt="user" class="media-object" src="{{asset('imgs/avtar/user.png')}}">
                                      </a>
                                      <div class="media-body">
    ...
    <!-- Calendar JS -->
    <script src="{{asset('js/plugins/calendar/calendar.js')}}"></script>
    <!-- Calendar Conf -->
    <script src="{{asset('js/plugins/calendar/calendar-conf.js')}}"></script>
